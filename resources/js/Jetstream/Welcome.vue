<template>
    <div>
        <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
            <div class="w-full">
                <jet-application-logo class="h-12 w-auto mx-auto" />
            </div>

            <div class="mt-8 text-2xl text-center">
                Welcome to Notch Relay!
            </div>

            <div class="mt-6 text-gray-500 text-center">
                Notch Relay is a wonderfull solution for storing email list and
                make marketing campagn.
            </div>
        </div>
